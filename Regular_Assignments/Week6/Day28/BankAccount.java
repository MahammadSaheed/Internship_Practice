...
class SavingsAccount extends BankAbstract {
...
class CheckingAccount extends BankAbstract {
  private String accountNumber;
  private double balance;
  ...
  void withdraw(double amount) {
    ...
    if (amount + withdrawalFee > this.balance) {
      ...
      System.out.println("Rs" + amount + " withdrawn from checking account " + this.accountNumber
          + ". Withdrawal fee of Rs" + withdrawalFee + " charged.");
    }
  }
...
class BankAccount {
  public static void main(String args[]) {
    BankAbstract a = new SavingsAccount("ahasgd7635474", 38621);
    a.deposit(15273);
    a.withdraw(6579);
    BankAbstract b = new CheckingAccount("ahasgd7635474", 38621);
    b.deposit(15273);
    b.withdraw(6579);
